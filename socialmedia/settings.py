...
#SECRET_KEY = 'django-insecure-@ix&+2gy3vb6smg0a87#fbunq^&-*c%!#e-u_uipp&^k=sab7v'
#using secret in env
...
ALLOWED_HOSTS = ['.vercel.app', '.now.sh', 'x', '127.0.0.1']
...
#connecting to supabse postgre data
DATABASES = {
    'default' : {
